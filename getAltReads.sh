...
do
    ...
    then
        ...
        # Run our new deduplicator/splitter, which attempts to compensate for bwa mem read corruption
        samtools view "${OUT_DIR}/${REGION}.bam" | ./smartSam2Fastq.py --fq1 "${OUT_DIR}/${REGION}.1.fq" --fq2 "${OUT_DIR}/${REGION}.2.fq"
    else
